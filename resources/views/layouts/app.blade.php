    ...
    <aside :class="{
        ...
        <nav class="flex-1 overflow-y-auto py-3 px-2 flex flex-col gap-1">
            ...
            @if(auth()->user()->isSupervisor())
                <x-sidebar-group label="Validasi">
                    <x-sidebar-item route="validasi.peminjaman" icon="ti-transfer-out" label="Peminjaman" />
                    <x-sidebar-item route="validasi.pengembalian" icon="ti-transfer-in" label="Pengembalian" />
                </x-sidebar-group>
            @endif
        ...
        <a href="{{ route('peminjaman.index') }}" wire:navigate
           class="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-slate-50">
            <div class="w-10 h-10 rounded-xl bg-violet-100 flex items-center justify-center">
                <i class="ti ti-transfer-out text-violet-600 text-xl"></i>
            </div>
            <span class="text-[10px] text-slate-600 font-medium text-center">Validasi Peminjaman</span>
        </a>
        <a href="{{ route('peminjaman.index') }}" wire:navigate
           class="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-slate-50">
            <div class="w-10 h-10 rounded-xl bg-green-100 flex items-center justify-center">
                <i class="ti ti-transfer-in text-green-600 text-xl"></i>
            </div>
            <span class="text-[10px] text-slate-600 font-medium text-center">Validasi Pengembalian</span>
        </a>
        @endif
    </div>
