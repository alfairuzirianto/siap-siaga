            ...
            <form wire:submit.prevent="save" class="p-6 space-y-6">
                ...
                <div class="space-y-1.5">
                    <label class="form-label text-slate-700 font-medium text-sm">
                        Peralatan <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        <label class="form-label text-slate-700 font-medium text-sm">Petugas <span class="text-red-500">*</span></label>
                    ...
                    <div class="space-y-1.5">
                        <label class="form-label text-slate-700 font-medium text-sm">Total Biaya Perbaikan</label>
                ...
                <div class="space-y-1.5 border-t border-slate-100 pt-4">
                    <label class="form-label text-slate-700 font-medium text-sm">Deskripsi Kerusakan & Tindakan <span class="text-red-500">*</span></label>
